...
public class Utils {
    ...
    public static String deduct(String ccNo, String exptDate, String cvvNo, float balance) {
    ...
    public static String isValid(String ccNo, String exptDate, String cvvNo, float balance) {
        // we will add encryption of data here. 
